          ...
          >
            <div className="grid grid-cols-1 gap-2 pb-4">
              ...
              <div className="flex items-center gap-3 px-2">
                <button
                  onClick={toggleTheme}
                  className="flex-1 flex items-center justify-center gap-2 h-12 rounded-2xl border border-white/10 bg-white/5 text-[var(--foreground)]"
                >
                  {themeIcon} <span className="text-xs uppercase tracking-wider">Mode</span>
                </button>
                <a
                  href="#contact"
                  onClick={() => setIsOpen(false)}
                  className="flex-[2] flex items-center justify-center h-12 rounded-2xl bg-gradient-to-r from-fuchsia-600 to-violet-600 text-white text-sm font-bold"
                >
                  Contact Me
                </a>
              </div>
